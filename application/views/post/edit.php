        ...
        <div class="card card-outline card-primary shadow-sm">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input id="post_title" name="post_title" class="form-control" type="text" placeholder="Post Title..." value="<?= set_value('post_title', $post->post_title); ?>" autocomplete="off">
                    <?= form_error('post_title'); ?>
                </div>
                <label for="summernote">Post Body</label>
                <textarea id="summernote" class="form-control" rows="6" name="post_body" placeholder="Post Body.."><?= set_value('post_body', $post->post_body); ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="department_id" name="department_id" aria-label="Floating label select example">
                        ...
                        <?php foreach ($department as $c) : ?>
                            <option value="<?= $c->department_id; ?>" <?= check($c->department_id, $post->department_id, "selected"); ?>><?= $c->department_name; ?></option>
                        <?php endforeach; ?>
                    </select>
