    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary sidebar-no-expand">
            ...
            <a href="<?= base_url('dashboard') ?>" class="brand-link navbar-dark">
                <img src="<?= base_url(); ?>assets/dist/img/clogo.png" alt="Logo" class="brand-image img-circle">
                <span class="brand-text text-white">Cladtek</span>
            </a>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column nav-flat nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
                        <?php if (userdata()->role == "admin") : ?>
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url('department'); ?>" class="nav-link <?= active_menu('department'); ?>">
                                    <i class="nav-icon fas fa-tags fa-fw"></i>
                                    <p>Department</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('dept_dashboard'); ?>" class="nav-link <?= active_menu('dept_dashboard'); ?>">
                                    <i class="nav-icon fas fa-tags fa-fw"></i>
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url('auth/register'); ?>" class="nav-link <?= active_menu('auth'); ?>">
                                    <i class="nav-icon fas fa-users fa-fw"></i>
                                    <p>Register</p>
                                </a>
                            </li>
